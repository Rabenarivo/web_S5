...
/**
 * Page Liste des Signalements - Affiche les signalements de l'utilisateur connecté
...
const ListeSignalements = () => {
  ...
  useEffect(() => {
    ...
    setUser(currentUser);
    loadSignalements(currentUser.idUtilisateur);
  }, [navigate]);
  ...
  const loadSignalements = async (idUtilisateur) => {
    try {
      ...
      // Filtrer pour n'afficher que les signalements de l'utilisateur connecté
      const allSignalements = response.signalements || response || [];
      const userSignalements = allSignalements.filter(sig => sig.idUtilisateur === idUtilisateur);
  ...
  return (
    <div className="container-fluid py-4" style={{ background: '#f8f9fa', minHeight: '100vh' }}>
      <div className="container">
        <h1 className="mb-4 fw-bold text-center" style={{ color: '#0d6efd' }}>Liste des Signalements</h1>
        ...
        <div className="card border-0 shadow-sm mb-4">
          <div className="card-header bg-primary text-white">
            <h5 className="mb-0">Carte des signalements</h5>
          </div>
        ...
        <div className="card border-0 shadow-sm">
          <div className="card-header bg-primary text-white">
            <h5 className="mb-0">Liste complète ({signalements.length})</h5>
          </div>
          <div className="card-body p-0">
